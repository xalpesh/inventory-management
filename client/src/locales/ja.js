export default {
  ...
  restocking: {
    title: '再入荷',
    description: '予算を設定し、需要予測から推奨された商品を再入荷します',
    budgetLabel: '利用可能な予算',
    budgetHelp: '予測需要と現在需要の差が大きい順に、予算内で商品を推奨します。',
    recommendedItems: '推奨商品',
    placeOrder: '注文する',
    placing: '注文中...',
    noRecommendations: 'この予算では推奨できる商品がありません。スライダーを増やしてみてください。',
    orderPlaced: '注文 {orderNumber} が送信されました。',
    summary: {
      itemCount: '推奨品目数',
      totalCost: '注文合計金額',
