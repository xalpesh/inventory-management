export default {
  ...
  restocking: {
    title: 'Restocking',
    description: 'Set a budget and restock items recommended from the demand forecast',
    budgetLabel: 'Available Budget',
    budgetHelp: 'Recommendations are prioritized by the largest gap between forecasted and current demand, fit to your budget.',
    recommendedItems: 'Recommended Items',
    placeOrder: 'Place Order',
    placing: 'Placing Order...',
    noRecommendations: 'No items to recommend at this budget. Try increasing the slider.',
